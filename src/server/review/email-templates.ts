  ...
  return {
    ...
    body: {
      ...
      intro: [
        ...
        'being invited. Otherwise, you may lose your spot. Simply let us know by RSVPing.',
      ...
      action: [
        makeInstruction({
          instructions: 'Let us know whether you will be attending or not on your dashboard. ' +
          'You will receive your tickets after you accept. ' +
          'Not to worry if you turn it down, we will give your ticket to someone else.',
          button: {
